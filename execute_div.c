...
/**
 * execute_div - divides the second element of the stack by the
 * first and saves the result in the second and pops the first.
 *
...
void execute_div(stack_t **head, unsigned int line_number)
{
	...
	/* divide node2 by node1 & save in node2 */
