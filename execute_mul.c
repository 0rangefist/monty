...
/**
 * execute_mul - multiplies the second element of the stack by
 * the first & saves the result in the second and pops the first.
 *
...
void execute_mul(stack_t **head, unsigned int line_number)
{
	...
	/* multiply node2 by node1 & save in node2 */
